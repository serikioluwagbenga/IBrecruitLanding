...
import { ServicesList, logo } from "../data";
              ...
              <div className="mb-6 md:mb-0">
                  <a href="https://flowbite.com/" className="flex items-center">
                    ...
                    <div className="flex gap-2">
                        ...
                        <p className=" text-slate-300 w-[300px]">11a, Mojidi Street, off Toyin Street, Ikeja, Lagos.</p>
                    </div>
                    <div className="flex gap-2">
                        <MdPhone className="text-green"/>
                        <p className="text-slate-300 w-[300px]">+234 812 001 2966 <br />
                            +234 901 278 1155</p>
                    </div>
                    <div className="flex gap-2">
                        <MdEmail className="text-green"/>
                        <p className="text-slate-300 w-[300px]">info@ibrecruit.com</p>
                    </div>
                    </div>
              </div>
                  ...
                  <div>
                      ...
                      <ul className="text-gray-500 dark:text-gray-400 font-medium">
                          {ServicesList && ServicesList.length > 0 ? ServicesList.map((service) => (
                            <li className="mb-4">
                                <a href={service.action.url} className="hover:underline text-slate-300">{service.title}</a>
                            </li>
                          )) : ""}
                      </ul>
                  </div>
